...
#Linux字符设备驱动结构
##字符设备驱动模板
![](https://img-blog.csdn.net/20160701180003455?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQv/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
下面具体说一下每个步骤的详细内容。
...
###4.2 Linux 2.6内核提供一组函数用于操作cdev 结构体<br><br>
...
###4.4 cdev结构的file_operations结构体<br><br>
...
###4.8字符设备驱动的 file_operations 结构体重成员函数<br><br>
...
第一个参数指定所要创建的设备所从属的类，<br><br>
第二个参数是这个设备的父设备，如果没有就指定为NULL，<br><br>
第三个参数是设备号，<br><br>
第四个参数是设备名称，<br><br>
第五个参数是从设备号。<br><br>
